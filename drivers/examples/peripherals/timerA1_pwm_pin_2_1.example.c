 ...
 *
 *
 * PWM SIGNAL GENERATED ON PIN2.2 (which is output pin for TA1CCR2 COMPARE EVT)
 */
#include <stdlib.h>
#include <msp430.h>
#include <stdint.h>
...
static void TIMERA1_pin_2_1_pwm_phy_init(void)
{
...
int main(void)
{
    ...
    TIMERA1_pin_2_1_pwm_phy_init();

    TA1CTL &= ~(MC0 | MC1); /* Stop timer */

    TA1CCR2 = TIMERA1_duty_cycle(25);
