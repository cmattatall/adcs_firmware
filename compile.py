...
def main():
    ...
    parser.add_argument("--test", action="store_true", dest="run_tests", help="option to build and run the automated tests as well as the project source")
    parser.add_argument("--build-test", action="store_true", dest="make_tests", help="Option to build (but not run) tests")
